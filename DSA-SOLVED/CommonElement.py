...
# We can perform intersection of two arrays keep the resulting array in temp
# and again perform intersection with 3rd array.

# Time complexity : O (arrlen1 + arrlen2 + arrlen3), Space Complexity : O(1)
def common_element_brute_force(arr1, arr2, arr3):
    arrlen1 = len(arr1)
    arrlen2 = len(arr2)
    arrlen3 = len(arr3)
    a = b = c = 0
...
common_element_brute_force(A, B, C)
# Output: Common Element is :  20
#         Common Element is :  80


# Handling duplicate, using previous element encountered
# Time complexity : O (arrlen1 + arrlen2 + arrlen3), Space Complexity : O(1)
def common_element_duplicate_handling(arr1, arr2, arr3):
    arrlen1 = len(arr1)
    arrlen2 = len(arr2)
    arrlen3 = len(arr3)
    a = b = c = 0
...
B = [6, 7, 20, 80, 100]
C = [3, 4, 15, 20, 30, 70, 80, 120]
common_element_duplicate_handling(A, B, C)
# Output: Common Element is :  20
#         Common Element is :  80
