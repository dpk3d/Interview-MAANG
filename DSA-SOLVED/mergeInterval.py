...
# In the worst case, the merged list is equal to the length of input intervals.
...
print("merged interval is : ", merge_interval(intervals))
# Output: merged interval is :  [[1, 6], [8, 10], [15, 18]]
