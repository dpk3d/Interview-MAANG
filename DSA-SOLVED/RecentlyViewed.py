...
def recent_items(list):
    ...
    data_list = [(v, k) for k, v in dictionary.items()]
    data_list.sort(reverse=True)
    return [each[1] for each in data_list]


logs = ["book1", "book2", "book3", "book1", "book3"]
print(" The Recently viewed items are", recent_items(logs))
